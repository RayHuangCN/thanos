...
func TestResourceTracker_MemoryBytesAllocated(t *testing.T) {
	t.Run("no tracking", func(t *testing.T) {
		err := alloc.ValidateTracking(1, 100, func(_ alloc.Tracker) {
			testWithAllocations_NoTracking()
		})
		testutil.NotOk(t, err)
		testutil.Equals(t, `6 errors: Untracked allocations of 32 Bytes for: 
    ...
    /home/bwplotka/.gvm/gos/go1.15/src/fmt/print.go:880 
...
; Untracked allocations of 128 Bytes for: 
...
; Untracked allocations of 32 Bytes for: 
    /home/bwplotka/Repos/thanos/pkg/isolation/usagepb/alloc/alloc_test.go:25 

; Untracked allocations of 32 Bytes for: 
    /home/bwplotka/Repos/thanos/pkg/isolation/usagepb/alloc/alloc_test.go:22 
...
`, err.Error())
	...
	t.Run("inaccurate tracking", func(t *testing.T) {
		err := alloc.ValidateTracking(1, 100, func(tr alloc.Tracker) {
	...
	t.Run("accurate tracking", func(t *testing.T) {
		testutil.Ok(t, alloc.ValidateTracking(1, 100, func(tr alloc.Tracker) {
